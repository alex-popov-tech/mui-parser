...
```html
<div class="MuiFormControl-root MuiFormControl-fullWidth MuiTextField-root css-11n4w43" data-testid="text-field">
  <label class="MuiFormLabel-root MuiInputLabel-root" data-shrink="true" for=":r3i:" id=":r3i:-label">
    URL
    <span aria-hidden="true" class="MuiFormLabel-asterisk MuiInputLabel-asterisk css-3fe08"> *</span>
  </label>
  <div class="MuiInputBase-root MuiOutlinedInput-root MuiInputBase-colorPrimary MuiInputBase-fullWidth MuiInputBase-formControl css-1rgex39">
    <input aria-invalid="false" id=":r3i:" name="secondaryNavigationDropdownLinks.0.url.values.en" required="" type="url" dir="auto" class="MuiInputBase-input MuiOutlinedInput-input css-13ny0hi" value="/b2b/4">
    <fieldset aria-hidden="true" class="MuiOutlinedInput-notchedOutline css-igs3ac">
      <legend class="css-14lo706"><span>URL *</span></legend>
    </fieldset>
  </div>
</div>
```
